package com.syntax.practice;
	...
	public class PassingNamesExcell  extends BaseClass {
		...
		public void addEmployee(String fName, String mName,String lName, String location) throws InterruptedException {
			...
			CommonMethods.click(addEmp.next);
	    ...
	    {
			String file_location="src/test/resources/testdata/OrangeHMData.xlsx";
			String SheetName= "Locations";
	    FileInputStream fileInputStream= new FileInputStream(file_location); //Excel sheet file location get mentioned here
	        workbook = new XSSFWorkbook (fileInputStream); //get my workbook 
	        worksheet=workbook.getSheet("Employees");// get my sheet from workbook
